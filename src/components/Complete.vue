                  ...
                  <div class="col-sm-8 mb-sm-30">
                    <div id="form-print" class="admission-form-wrapper">
                          ...
                          <table class="table">
                            ...
                            <tr>
                              <td><a href="product-page.html">
                                <div class="product-image"><img alt="Gecko" src="static/images/1.jpg"></div>
                              </a></td>
                              <td>
                                <div class="product-title"><a href="product-page.html">Cross Colours Camo Print Tank
                                  half mengo</a>
                            ...
                            <tr>
                              <td><a href="product-page.html">
                                <div class="product-image"><img alt="Gecko" src="static/images/2.jpg"></div>
                              </a></td>
                              <td>
                                <div class="product-title"><a href="product-page.html">Cross Colours Camo Print Tank
                                  half mengo</a>
                      ...
                      <div class="mb-30">
                        ...
                        <hr>
                        <p class="mt-20">Quisque id fermentum tellus. Donec fringilla mauris nec ligula maximus sodales.
                          Donec ac felis nunc. Fusce placerat volutpat risus, ac fermentum ex tempus eget.</p>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-xs-12">
                        <div class="print-btn mt-30">
                          <button onclick="printDiv('form-print')" class="btn btn-color" type="button">Print</button>
                          <div class="right-side float-none-xs"><a class="btn btn-black" href="shop.html"><span>
                          <i class="fa fa-angle-left"></i></span>Continue Shopping</a>
                          </div>
                        </div>
                      </div>
                    </div>
